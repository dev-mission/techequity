...
router.get('/', async function(req, res) {
  const programDirectors = await models.ProgramDirectors.findAll({
...
router.post('/',  async function(req, res) {
  const programDirectors = models.ProgramDirectors.build(req.body);
  try {
...
router.get('/:id', async function(req, res) {
  const programDirectors = await models.ProgramDirectors.findByPk(req.params.id);
  if (programDirectors) {
